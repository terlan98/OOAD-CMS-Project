...
import static edu.ada.cms_spring.Constants.ApplicationConstants.*;
		...
		try {
			...
			if (range == null) {
				return ResponseEntity.status(HttpStatus.OK)
						...
						.body(readByteRange(fullFileName, rangeStart, 1024)); // Read the object and convert it as bytes
			}
